...
import heroBgImage from '../assets/img/company-page.png';
import innoBgImage from '../assets/img/company-2.avif';
import pioBgImage from '../assets/img/company-3.avif';
...
{/* Redesigned Pill Button with Trailing Icon */}
            <Link to="/connect" className="btn-primary" aria-label="Build Your AI Infrastructure">
              <span>{companyData.vision.button}</span>
              <svg 
                width="20" 
                height="16" 
                viewBox="0 0 20 16" 
